...
// check_vote_db.php// check_vote_db.php

require_once __DIR__ . '/src/services/DatabaseConnection.php';// Проверка структуры баз данных через контроллер миграций

require_once __DIR__ . '/bootstrap.php';

try {require_once __DIR__ . '/src/controllers/MigrationController.php';
